    ...
    if button["text"] == " ":
        if turn == "x" :
            ...
            if mode == "singlePlayer":
                ...
                if checkForWin(turn):
                    if turn == 0 :
                        winningLabel = Label(frame1 , text=f"{turn} wins the game", bg="orange", font=("Arial" , 22),width=18   )
                    else:
                        winningLabel = Label(frame1 , text=f"Ngwere wins the game", bg="orange", font=("Arial" , 22),width=18   )    
                    winningLabel.grid(row = 0 , column=0 , columnspan=3)
                    game_end = True
